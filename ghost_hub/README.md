...
|8|User wants to delete comment|1. From the Cases List page, click on "Continue" button on one of the cases. Scroll down to the "Comments" section.<br>2. Click on "Delete"|A popup box in green will appear saying that "Comment Deleted"|
