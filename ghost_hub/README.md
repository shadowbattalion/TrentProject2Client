...
|6|User wants to post comment|1. Click on "Continue" button. Scroll down to the "Comments" section, enter in the textbox: This is very scary!<br>2. Click on "Add!"|A popup box in green will appear saying that "Comment Added"|
|7|User wants to edit comment|1. Click on "Continue" button. Scroll down to the "Comments" section.<br>2. Click on "Edit" on the comment added earlier, enter in the textbox: This is not so scary!<br>3. Click on "Done!"|A popup box in green will appear saying that "Comment Edited" and the earlier added comment has been changed|
|8|User wants to delete comment|1. Click on "Continue" button. Scroll down to the "Comments" section.<br>2. Click on "Delete"|A popup box in green will appear saying that "Comment Deleted"|
